...
import {StatusRolesDirective} from "./directives/status-roles.directive";
import {RolesComponent} from "./components/roles.component";

@NgModule({
  declarations: [StatusRolesDirective, RolesComponent],
  imports: [
    CommonModule,
    SharedModule,
    TranslateModule.forChild(),
    StoreModule.forFeature('roles', {
      auth: authReducer,
  ...
  exports: [StatusRolesDirective, RolesComponent]
})
